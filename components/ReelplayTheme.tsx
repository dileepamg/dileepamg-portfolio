...
type ReelplayThemeProps = {
  children?: ReactNode;
};

export default function ReelplayTheme({ children }: ReelplayThemeProps) {
  return (
    <>
      <template
        id="media-theme-reelplay"
        dangerouslySetInnerHTML={{
          ...
          <style>
            :host {
              ...
              --_embossed: 0 -1px 0 0 #7b7b7b, 0 -2px 0 0 #000,
                -1px 0 0 0 #7b7b7b, 1px 0 0 0 white,
                0 1px 0 0 white;
            }
          ...
          >
            ...
            <div slot="top-chrome">
              <div class="top-bar">
                <span>Fun Motion Stuff</span>
              </div>

              <media-control-bar>
                <!-- KEEP: main play/pause button -->
                <media-play-button class="play" mediacontroller="controller">
                  <div slot="play"></div>
                  <div slot="pause"></div>
                </media-play-button>

                <!-- REMOVED: extra pause + stop buttons from original -->
            ...
            <!-- SIMPLIFIED bottom bar: only time display -->
      ...
      <MediaTheme template="media-theme-reelplay" style={{ width: "100%" }}>
        {children}
      </MediaTheme>
    </>
  );

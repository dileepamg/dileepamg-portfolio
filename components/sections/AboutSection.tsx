  ...
  return (
    <section id="about" className="scroll-mt-16">
      <div>
        ...
        <p className="mt-4 text-sm break-words sm:text-lg md:mt-8">
          I started my career as a creative designer doing freelance work in the
          digital marketing space. Since then I was engaged in digital
          ...
          design working at Tracified where I designed experiences for both web

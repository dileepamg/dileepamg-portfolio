...
export default function Nav() {
  ...
  return (
    <div className="fixed top-5 left-5 z-50 w-full">
      {/* Desktop Navigation */}
      <nav className="text-main-foreground border-border shadow-shadow rounded-base bg-main font-base mx-auto hidden w-max gap-5 border-2 p-2.5 px-5 text-sm sm:flex sm:text-base">
        {links.map((link) => {
          return (
            <Link
              key={link.path}
      ...
      <div className="sm:hidden">
        ...
        {isOpen && (
          <>
            ...
            {/* Menu Content */}
            <div className="text-main-foreground border-border shadow-shadow rounded-base bg-main absolute left-5 right-5 top-16 border-2 p-4">
